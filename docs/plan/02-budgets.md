...
| + C1 corroboration (opt-in, default ON, v0.6.0) | **p50 holds ≤3.0s**: +1 CE batch (~5 cross-cluster pairs) measured **312ms p50 / 508ms p99** on-device (suite-20, n=1080) ⇒ answer p50 ≈ **2813ms** (headroom 498→187ms). The roadmap's ~10–20ms guess was WRONG (ms-marco INT8 ≈60ms/pair on the A76) — recorded, not absorbed. CE deadline capped at 450ms so the worst case ≈2952ms; on overrun the count thins, never inflates | same | knob `search.answer_corroborate` (off to reclaim the 312ms); `2026-06-13-pi5-c1-corroboration.md` |
